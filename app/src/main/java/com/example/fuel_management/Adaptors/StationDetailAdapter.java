...
public class StationDetailAdapter extends BaseAdapter {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        convertView = inflater.inflate(R.layout.station_detail_user_card,null);
        TextView textView = (TextView) convertView.findViewById(R.id.Txt_User_Card_Station_Name);
